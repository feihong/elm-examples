...
var _user$project$Main$btnDefault = F2(
	function (btnType, label) {
		return A2(
			_elm_lang$html$Html$button,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('btn btn-default'),
					_elm_lang$html$Html_Attributes$type$(btnType)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$name(cbxName),
									_elm_lang$html$Html_Attributes$type$('checkbox')
								]),
							_elm_lang$core$Native_List.fromArray(
								[])),
							_elm_lang$html$Html$text(cbxText)
						]))
				]));
	});
var _user$project$Main$bootstrapForm = A2(
	_elm_lang$html$Html$form,
	_elm_lang$core$Native_List.fromArray(
		[]),
	_elm_lang$core$Native_List.fromArray(
		[
			_circuithub$elm_bootstrap_html$Bootstrap_Html$formGroup_(
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					_elm_lang$html$Html$label,
			...
			A2(_user$project$Main$checkbox, 'coolio', 'Check me out'),
			A2(_user$project$Main$btnDefault, 'submit', 'Submit')
		]));
var _user$project$Main$grid = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					A3(
					_circuithub$elm_bootstrap_html$Bootstrap_Html$colSm_,
					6,
					2,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('6 2')
						])),
					A3(
					_circuithub$elm_bootstrap_html$Bootstrap_Html$colSm_,
					6,
...
var _user$project$Main$main = {
	main: _circuithub$elm_html_shorthand$Html_Shorthand$div_(
		_elm_lang$core$Native_List.fromArray(
			[
				_circuithub$elm_html_shorthand$Html_Shorthand$h2_('Responsive grid system'),
				_user$project$Main$grid,
				_circuithub$elm_html_shorthand$Html_Shorthand$h2_('Forms'),
				_user$project$Main$bootstrapForm
			]))
};
