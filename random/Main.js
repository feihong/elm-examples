...
var _user$project$Main$generate = A2(
	_elm_lang$core$Random$generate,
	_user$project$Main$NewNumber,
	A2(_elm_lang$core$Random$int, 19968, 40959));
var _user$project$Main$init = {ctor: '_Tuple2', _0: 0, _1: _user$project$Main$generate};
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'Generate') {
			return {ctor: '_Tuple2', _0: model, _1: _user$project$Main$generate};
		} else {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('hanzi')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						_elm_lang$core$String$fromChar(
							_elm_lang$core$Char$fromCode(model)))
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onClick(_user$project$Main$Generate)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
