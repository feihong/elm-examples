...
var _user$project$Main$btnClass = _elm_lang$html$Html_Attributes$class('btn btn-default');
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {content: a, errorMsg: b, version: c};
	});
var _user$project$Main$Failure = function (a) {
	return {ctor: 'Failure', _0: a};
};
var _user$project$Main$SuccessJson = function (a) {
	return {ctor: 'SuccessJson', _0: a};
};
var _user$project$Main$fetchJson = function (url) {
	var decodeElmVersion = A2(
		_elm_lang$core$Json_Decode$at,
		_elm_lang$core$Native_List.fromArray(
			['elm-version']),
		_elm_lang$core$Json_Decode$string);
	return A3(
		...
		_user$project$Main$SuccessJson,
		A2(_evancz$elm_http$Http$get, decodeElmVersion, url));
};
var _user$project$Main$FetchJson = function (a) {
	return {ctor: 'FetchJson', _0: a};
};
var _user$project$Main$Success = function (a) {
	return {ctor: 'Success', _0: a};
};
var _user$project$Main$fetch = function (url) {
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Main$Failure,
...
var _user$project$Main$init = {
	...
	_1: _user$project$Main$fetch('elm-package.json')
};
		...
		switch (_p0.ctor) {
			case 'Fetch':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$fetch(_p0._0)
				};
			case 'Success':
				return {
					ctor: '_Tuple2',
			...
			case 'FetchJson':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$fetchJson(_p0._0)
				};
			case 'SuccessJson':
				return {
					ctor: '_Tuple2',
...
var _user$project$Main$Fetch = function (a) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Contents of this program\'s elm-package.json:')
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Main$btnClass,
						_elm_lang$html$Html_Events$onClick(
						_user$project$Main$FetchJson('elm-package.json'))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Get Elm version')
					])),
				A2(
				_elm_lang$html$Html$p,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Elm version: '),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(model.version)
							]))
					])),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Main$btnClass,
						_elm_lang$html$Html_Events$onClick(
						_user$project$Main$Fetch('does-not-exist.json'))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Make failing request')
					])),
				A2(
				_elm_lang$html$Html$p,
				_elm_lang$core$Native_List.fromArray(
