...
var _user$project$Hanzi$hanzi = A2(
	_elm_lang$core$Random$map,
	function (x) {
		return _elm_lang$core$String$fromChar(
			_elm_lang$core$Char$fromCode(x));
	},
	A2(_elm_lang$core$Random$int, 19968, 40959));
...
var _user$project$Main$NewHanzi = function (a) {
	return {ctor: 'NewHanzi', _0: a};
};
var _user$project$Main$generateHanzi = A2(_elm_lang$core$Random$generate, _user$project$Main$NewHanzi, _user$project$Hanzi$hanzi);
var _user$project$Main$init = {ctor: '_Tuple2', _0: '', _1: _user$project$Main$generateHanzi};
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'Generate') {
			return {ctor: '_Tuple2', _0: model, _1: _user$project$Main$generateHanzi};
		} else {
