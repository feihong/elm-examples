...
var _user$project$Main$emptyModel = {
	...
	taxPercent: 9.75,
	tipPercent: 20,
	orders: _elm_lang$core$Native_List.fromArray(
		[])
};
...
var _user$project$Main$Order = F3(
	function (a, b, c) {
		return {payer: a, item: b, amount: c};
	});
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {attendees: a, taxPercent: b, tipPercent: c, orders: d};
	});
