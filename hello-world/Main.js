...
var _user$project$Main$defaultValue = 'Hello World';
var _user$project$Main$choices = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'English', _1: _user$project$Main$defaultValue},
		{ctor: '_Tuple2', _0: 'German', _1: 'Hallo Welt'},
		{ctor: '_Tuple2', _0: 'Chinese', _1: '你好世界'},
		{ctor: '_Tuple2', _0: 'Japanese', _1: 'こんにちは世界'},
		{ctor: '_Tuple2', _0: 'Esperanto', _1: 'Saluton mondo'}
	]);
var _user$project$Main$model = {greeting: _user$project$Main$defaultValue, choices: _user$project$Main$choices};
var _user$project$Main$Model = F2(
	function (a, b) {
		return {greeting: a, choices: b};
	});
var _user$project$Main$CurrentGreeting = function (a) {
	return {ctor: 'CurrentGreeting', _0: a};
};
var _user$project$Main$languageButton = F2(
	function (greeting, _p2) {
		var _p3 = _p2;
		var _p4 = _p3._1;
		return A2(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							{ctor: '_Tuple2', _0: 'btn-default', _1: true},
							{
							ctor: '_Tuple2',
							_0: 'btn-info',
							_1: _elm_lang$core$Native_Utils.eq(greeting, _p4)
						}
						])),
					_elm_lang$html$Html_Events$onClick(
					_user$project$Main$CurrentGreeting(_p4))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
...
var _user$project$Main$view = function (model) {
	var languageButtons = A2(
		_elm_lang$core$List$map,
		_user$project$Main$languageButton(model.greeting),
		model.choices);
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(model.greeting)
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
